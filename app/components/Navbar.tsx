  ...
  return (
    <nav className="sticky top-0 z-50 w-full flex items-center justify-between px-4 py-5 bg-white shadow-md">
      ...
      <div className="flex-grow px-4">
        ...
        <Link href="/" passHref>
          <span className="ml-5 text-gray-800 mt-8 mb-5 dark:text-gray-300 text-sm cursor-pointer ">
            <span className="">Latest Stories</span>
          </span>
        </Link>
        <Link href="/" passHref>
          <span className="ml-5 text-gray-800 mt-8 mb-5 dark:text-gray-300 text-sm cursor-pointer">
        ...
        <Link href="/" passHref>
          <span className="ml-5 text-gray-800 mt-8 mb-5 dark:text-gray-300 text-sm cursor-pointer">
            <span className="">AI Stories</span>
          </span>
        </Link>

        <Link href="/" passHref>
          <span className="ml-5 text-gray-800 mt-8 mb-5 dark:text-gray-300 text-sm cursor-pointer">
            <span className="">Learn Programming</span>
          </span>
        </Link>
